...
birth_weight_file = r"D:\06_scientific research\01_train_roi\02_roistas_csv\02_filled\willowcreek_DB_1000_roistats.csv"
...
for i in Y:
    if len(Y) == 366:    #这里的10为你想要固定长度list的长度
       print(Y)  # i.append(0)     #添加list a 中的最后一个元素
        ...
        m = random.uniform(0.32700, 0.33100)
        Y.append(m)
...
plt.axvline(x=128,ls="--",c="blue",label = "SOS")#添加垂直直线
plt.axvline(x=277,ls='--',c="blue",label = "EOS")#添加垂直直线;'-', '--', '-.', ':', 'None', ' ', '', 'solid', 'dashed', 'dashdot', 'dotted'
# plt.text(42,0.42,"SOS",fontsize = 12,c="blue")
plt.text(102,0.42,"SOS",c="blue")

# plt.text(275,0.42,"EOS",fontsize = 12,c="blue")
plt.text(279,0.42,"EOS",c="blue")
...
plt.title("The value of Gcc in Willowcreek")
plt.legend(loc = "best")
...
plt.savefig(r"D:\06_scientific research\07_result\02_GccScatter\5_willowcreek.tif")
plt.show()
